      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{ asset('assets/img/128x128.jpg') }}" alt="User Avatar" class="img-size-50 mr-3 img-circle">
...
<!-- Control Sidebar -->
<aside class="control-sidebar control-sidebar-dark"> k!-- Control sidebar content goes here -->
     </aside>
<!--/.control-sidebar
</div>
